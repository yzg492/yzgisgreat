...
<body>
<%
AppointmentService personalappointmentService = new AppointmentService();

List<Appointment> appointmentList = personalappointmentService.getpersonalAppointmentList(session);
